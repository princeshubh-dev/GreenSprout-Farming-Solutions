		...
		<!-- Footer -->
			...
			<div class="footer-center">
				<div>
					...
					<p style="font-size:20px">Savitribai Phule Pune University<span>Pune 411016</span></p>
				</div>
				<div>
				...
				<div>
					...
					<p style="font-size:20px"><a href="mailto:mr.shubhamgore@gmail.com" style="color:white">mr.shubhamgore@gmail.com</a></p>
				</div>
			</div>
			...
			<div class="footer-right">
				<p class="footer-company-about" style="color:white">
					...
					About Farmers Herlping Platform By Shubham Gore
				</p>
